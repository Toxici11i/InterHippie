...
/datum/wound/puncture
	bleed_threshold = 5
	autoheal_cutoff = 15   // the maximum amount of damage that this wound can have and still autoheal
	damage_type = PIERCE
...
/datum/wound/puncture/gaping_big
	max_bleeding_stage = 3
	stages = list(
		"massive gaping hole" = 50,
		"huge gaping hole" = 25,
		"large gaping hole" = 20,
		"large blood soaked hole" = 15,
		"large angry scar" = 5,
		"large round scar" = 0
		)
