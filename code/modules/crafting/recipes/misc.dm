...
/datum/crafting_recipe/misc/anister
	name = "canister"
...
/datum/crafting_recipe/misc/folder
	name = "grey folder"
	result = list(/obj/item/weapon/folder = 1)
	parts = list(MATERIAL_CARDBOARD_TYPE = 1)

/datum/crafting_recipe/misc/folder/blue
	name = "blue folder"
	result = list(/obj/item/weapon/folder/blue = 1)

/datum/crafting_recipe/misc/folder/red
	name = "red folder"
	result = list(/obj/item/weapon/folder/red = 1)

/datum/crafting_recipe/misc/folder/white
	name = "white folder"
	result = list(/obj/item/weapon/folder/white = 1)

/datum/crafting_recipe/misc/folder/yellow
	name = "yellow folder"
...
*/
/datum/crafting_recipe/misc/tray
	time = 40
	name = "dinner tray"
